        ...
        fetch('https://api.npoint.io/1965674b4266bb25a804')
          ...
          .then((examinations) => {
            ...
            if (q > 0) {
              ...
              message.textContent = `${q / 6} ismertlen órád van. Ennek oka az, hogy nem tudjuk milyen órákon veszel részt ilyenkor. Jelezz vissza nekünk és mi frissítjük az óráidat`
